...
if (!function_exists('trucking_setup')) :
    ...
    function trucking_setup()
    {
        ...
        add_image_size('header_logo', 400, 400);

        // This theme uses wp_nav_menu() in one location.
        register_nav_menus(array(
            'menu-1' => esc_html__('Primary', 'trucking'),
            'header_sub_menu' => esc_html__('Header Sub Menu', 'trucking'),
            'footer_first_sub_menu' => esc_html__('Footer First Menu', 'trucking'),
            'footer_second_sub_menu' => esc_html__('Footer Second Menu', 'trucking'),
        ));
 ...
 */
function trucking_content_width()
{
    // This variable is intended to be overruled from themes.
    // Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
    // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
    $GLOBALS['content_width'] = apply_filters('trucking_content_width', 640);
}

add_action('after_setup_theme', 'trucking_content_width', 0);
 ...
 */
function trucking_widgets_init()
{
    register_sidebar(array(
        'name' => esc_html__('Sidebar', 'trucking'),
        'id' => 'sidebar-1',
        'description' => esc_html__('Add widgets here.', 'trucking'),
...
add_action('widgets_init', 'trucking_widgets_init');
...
{
//	wp_enqueue_style( 'trucking-style', get_stylesheet_uri() );
    ...
    wp_register_style('slick-css', 'https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.9.0/slick.min.css');
    ...
    wp_register_script('slick-js', 'https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.9.0/slick.min.js', array('jquery'), null, true);
...
add_action('wp_enqueue_scripts', 'trucking_scripts');
...
function support_svg($mime_types)
{
    $mime_types['svg'] = 'image/svg+xml';
    return $mime_types;
}

add_filter('upload_mimes', 'support_svg', 1, 1);
